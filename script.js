...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = document.querySelectorAll('a[href^="index.html"], a[href^="shop.html"], a[href^="cart.html"], a[href^="about.html"]');
    links.forEach(link => {
        link.addEventListener('click', handlePageTransition);
    });

    // Add fade-in or slide-in effect when the page loads
    const transitionEffect = Math.random() < 0.5 ? 'fade' : 'slide';
